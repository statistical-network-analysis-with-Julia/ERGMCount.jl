...
makedocs(
    ...
    format = Documenter.HTML(
        ...
        canonical = "https://statistical-network-analysis-with-Julia.github.io/ERGMCount.jl/dev/",
    ...
    repo = Documenter.Remotes.GitHub("Statistical-network-analysis-with-Julia", "ERGMCount.jl"),
    pages = [
        "Home" => "index.md",
